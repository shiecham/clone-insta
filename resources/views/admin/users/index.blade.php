...
@section('content')
    <table class="table table-hover align-middle bg-white boder text-secondary">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    {{-- <button class="dropdown-item text-danger" data-bs-toggle="modal"
                                        ...
                                        <i class="fa-solid fa-user-slash"> Deactive {{ strtolower($user->name) }}</i>
                                    ...
                                    @else
                                        <button class="dropdown-item text-danger" data-bs-toggle="modal"
                                            data-bs-target="#deactivate-user-{{ $user->id }}">
                                            <i class="fa-solid fa-user-slash"> </i>Deactive {{ strtolower($user->name) }}
